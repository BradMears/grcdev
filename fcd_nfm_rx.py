...
# Generated: Sun Oct 20 22:11:54 2019
##################################################
...
class fcd_nfm_rx(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self._width_win = RangeWidget(self._width_range, self.set_width, "Filter", "counter", float)
        self.top_grid_layout.addWidget(self._width_win, 7,0,1,1)
        self._trans_range = Range(500, 5000, 1, 1500, 200)
        self._trans_win = RangeWidget(self._trans_range, self.set_trans, "Trans", "counter", float)
        self.top_grid_layout.addWidget(self._trans_win, 8,0,1,1)
        self._sql_lev_range = Range(-100, 0, 1, -100, 200)
        self._sql_lev_win = RangeWidget(self._sql_lev_range, self.set_sql_lev, "SQL", "counter", float)
        ...
        self._offset_fine_win = RangeWidget(self._offset_fine_range, self.set_offset_fine, "Fine Tune", "counter", float)
        self.top_grid_layout.addWidget(self._offset_fine_win, 6,0,1,2)
        self._offset_coarse_range = Range(-48000, 48000, 100, 0, 200)
        self._offset_coarse_win = RangeWidget(self._offset_coarse_range, self.set_offset_coarse, "Coarse Tune", "counter", float)
        ...
        self._af_gain_win = RangeWidget(self._af_gain_range, self.set_af_gain, "VOL", "counter", float)
        ...
        self._rf_gain_win = RangeWidget(self._rf_gain_range, self.set_rf_gain, "RF", "counter", float)
...
def main(top_block_cls=fcd_nfm_rx, options=None):
